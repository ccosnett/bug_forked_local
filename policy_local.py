...
class buy_bitcoins(BasePolicy):  # type: ignore
    ...
    def dump_dollars(self, agent):
        ...
        amount_to_dump = amount_of_dollars*self.dump_rate

        if amount_of_dollars > amount_to_dump:
    ...
    def buy_bitcoin(self, agent):
        ...
        amount_to_dump = amount_of_WETH * self.dump_rate
        if amount_of_WETH > amount_to_dump:
